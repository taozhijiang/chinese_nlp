...
def enum_params():     
    ...
    # FEATURE & ARGS TEST
    ###########################################
    methods = {'MultinomialNB':MultinomialNB(), 'BernoulliNB':BernoulliNB(), 'LogisticRegression':LogisticRegression(), \
    'LinearSVC':LinearSVC(), 'NuSVC':NuSVC()}
    ...
    for m, m_c in methods.items():
        ...
        for f_n in feature_n:
            ...
            classifier = build_classifier(m_c, train_feature)
